...
<head>
    ...
    <title>VitalDrop Management System | Admin Login</title>
...
<body>
    ...
    <div class="login-page bk-img" style="background-image: linear-gradient(gray);">
        <div class="form-content">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <h1 class="text-center text-bold text-light mt-4x">VitalDrop Management System Sign in</h1>

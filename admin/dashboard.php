...
<head>
	...
	<title>VitalDrop| Admin Dashboard</title>
...
?>
											...
											<a href="manage-bloodgroup.php" class="block-anchor panel-footer"> Details <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<div class="col-md-4">
										<div class="panel panel-default">
...
?>
											...
											<a href="donor-list.php" class="block-anchor panel-footer text-center"> Details &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
									<!-- <div class="col-md-4">
										<div class="panel panel-default">
...
?>
											...
											<a href="requests-received.php" class="block-anchor panel-footer text-center"> Details &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>

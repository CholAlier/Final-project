...
<head>
	<title>VitalDrop Management System | Home Page</title>
	...
	<div class="screen-w3ls py-5">
		<div class="container py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">blood group of any human being falls in any one of the following groups..</p>
			</div>
			<div class="row">
            <div class="col-lg-6">
...
<li>AB positive or AB negative.</li>
                ...
                <p>A good diet  ensures  a successful blood donation, and also makes you feel great! Check out the following recommended foods to eat prior to your donation.</p>
            </div>
            <div class="col-lg-6">
...
Type O people are often called universal donors since their blood can be transfused into persons with any blood type. People with type AB blood are called universal recipients because they can receive blood of any kind.</p>
            </div>
